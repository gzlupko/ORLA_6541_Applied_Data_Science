...
# legend for the plot 
legend("bottomright", legend=c("GPA", "Extracur. (2004)", "AP"), lty=c(12, 13,14), lwd = 2)
...
# print AUC values and store to a vector
auc_fig3a <- c(stem_degree1$auc, stem_degree2$auc, stem_degree3$auc) 

# store predictor names in a vector
predictor_fig3a <- c("Number of STEM Courses", "Math t score (2002)", "STEM GPA")    
