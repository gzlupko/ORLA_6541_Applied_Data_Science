...
Using the data and links to the movies that the movie reviews in the IMDB dataset review to, compare the movies to the latent topics you have identified in the CTM. Consider running the code in #1 above with a larger sample to have enough documents and movies per topic to do a comparison.
Search on google scholar or other examples of textmining using the IMDB dataset, and include some aspect of the extended analysis in the literature into the positive reviews IMDB CTM.
