...
Using data.table syntax to subset the data set, we found that there are 3,197 female students from Germany in the data set. 
...
#### The .N function returns the length of a vector/number of rows. Use chaining with the .N function to answer Exercise 2.
