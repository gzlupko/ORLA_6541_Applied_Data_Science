...
- Which version is better for examining the science score distribution?
  - The alpha = 0.5 version is better for reviewing the science score distribution as transparency allows for a better view 
  - of the full distribution of the plot of the different regions  
  - The opacity of the alpha = 0.8 plot conceals much of the plot of the regions plotted behind
