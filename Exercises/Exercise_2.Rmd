...
- Do you think that the relationship between ESCS and math changes across gender and regions?
  ...
  - Overall, across all regions and both genders, socio-economic status holds a positive relationship with Math scores,
  - ie higher math scores indicate, higher socio-economic status
  - The relationship between seems to be comparable between genders within each region
...
- Create an alluvial plot for the survey item (ST119Q01NA) of whether students want top grades in most or all courses by region (Region) and gender (sex).
