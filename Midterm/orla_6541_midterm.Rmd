...
ee_data %>%
  ...
  geom_point() + geom_smooth(method = lm, se = FALSE) +  scale_color_manual(
    values = c(High = "#FFDB6D", Neutral = "#0d88e6"), 
    guide = "none") + labs(x = "Conscientiousness", 
                           y = "Responsibility-taking Behavior", 
                           title = "When conscientious employees are more<strong><span style = 'color:#4421af'><b> engaged </strong>they demonstrated higher RTB") + theme(plot.title = element_markdown())
