...
[add in graphic annotations for the neutral and high lines for engagement]
```{r, message = FALSE}
library(ggtext) 
...
```{r, message = FALSE}
ee_con_mod <- lm(RTB_score ~ conscientiousness*employee_engagement, data = study_data)
...
h1 <- Heatmap(data_mat, name = "RTB Heatmap", 
